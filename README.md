...
This repository contains the code used for the analysis in SSIM916 Problem Set 2.
...
The full methodology, results, and discussion are presented in the accompanying report. This repository focuses on providing the implementation required to reproduce the analysis.
...
No manual download is required, as the script loads the dataset automatically.
...
These outputs correspond directly to the figures and tables presented in the report.
